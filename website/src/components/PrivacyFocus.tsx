...
export default function PrivacyFocus() {
  ...
  return (
    <section id="privacy" className="py-16 md:py-24 bg-white relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-[1000px] h-[600px] bg-[#7C3AED]/5 blur-[120px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-[1200px] mx-auto px-6 relative z-10">
        ...
        >
          ...
          <div className="w-16 h-16 rounded-2xl bg-[#EDE9FE]/50 border border-[#7C3AED]/20 flex items-center justify-center mb-8 shadow-sm">
            <Shield className="w-8 h-8 text-[#7C3AED] fill-[#7C3AED]/10" />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          {highlights.map((item, idx) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-[#7C3AED]/0 to-[#7C3AED]/0 group-hover:to-[#7C3AED]/[0.03] transition-colors duration-500 pointer-events-none" />
